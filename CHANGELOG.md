...
* `vault_ldap_secret_backend_static_role`: Add support for dual-account (blue/green) rotation mode via `dual_account_mode`, `username_b`, `dn_b`, and `grace_period` fields. Requires Vault 1.21+. ([#1](https://github.com/andybaran/terraform-provider-vault/issues/1))
